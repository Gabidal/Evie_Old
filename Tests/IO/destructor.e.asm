...
mov rcx, rax		#internal_allocate_TMP_1710183406256, RetREG_0
add qword ptr [rcx + 0 ], 1		#internal_allocate_TMP_1710183406256_0, 1
mov rbx, rcx		#Return_Value98_100, internal_allocate_TMP_1710183406256
jmp Return_Here_135		#Return_Here_135
Return_Here_135:
mov rcx, rbx		#Return_Value98_100_TMP_1710183414320, Return_Value98_100
add qword ptr [rcx + 0 ], 1		#Return_Value98_100_TMP_1710183414320_0, 1
mov rdi, rcx		#this_99_100, Return_Value98_100_TMP_1710183414320
mov rdi, rbx		#this_99_100, Return_Value98_100
mov dword ptr [rdi + 8 ], 1		#this_99_100_8, 1
mov dword ptr [rdi + 12 ], 2		#this_99_100_12, 2
mov rcx, rdi		#this_99_100_TMP_1710183430448, this_99_100
add qword ptr [rcx + 0 ], 1		#this_99_100_TMP_1710183430448_0, 1
mov rsi, rcx		#Return_Value99_100, this_99_100_TMP_1710183430448
...
mov rcx, rcx		#F_100_TMP_1710183439408, F_100_REG1
add qword ptr [rcx + 0 ], 1		#F_100_TMP_1710183439408_0, 1
mov rcx, rcx		#handle_1_100, F_100_TMP_1710183439408
...
call _V17internal_allocatex_rPh
mov rcx, rax		#internal_allocate_TMP_1710183446576, RetREG_0
add qword ptr [rcx + 0 ], 1		#internal_allocate_TMP_1710183446576_0, 1
mov rbx, rcx		#Return_Value98, internal_allocate_TMP_1710183446576
jmp Return_Here_132		#Return_Here_132
Return_Here_132:
mov rcx, rbx		#Return_Value98_TMP_1710183458224, Return_Value98
add qword ptr [rcx + 0 ], 1		#Return_Value98_TMP_1710183458224_0, 1
mov rdi, rcx		#this_99, Return_Value98_TMP_1710183458224
mov rdi, rbx		#this_99, Return_Value98
mov dword ptr [rdi + 8 ], 1		#this_99_8, 1
mov dword ptr [rdi + 12 ], 2		#this_99_12, 2
mov rcx, rdi		#this_99_TMP_1710183469872, this_99
add qword ptr [rcx + 0 ], 1		#this_99_TMP_1710183469872_0, 1
mov rsi, rcx		#Return_Value99, this_99_TMP_1710183469872
...
mov rcx, rcx		#F_TMP_1710183459120, F_REG1
add qword ptr [rcx + 0 ], 1		#F_TMP_1710183459120_0, 1
mov rcx, rcx		#handle_1, F_TMP_1710183459120
...
mov r8, rcx		#this_TMP_1710183462704, this
add qword ptr [r8 + 0 ], 1		#this_TMP_1710183462704_0, 1
mov rbx, r8		#Address_97, this_TMP_1710183462704
