...
mov rcx, rax		#internal_allocate_TMP_1445910543168, RetREG_0
add qword ptr [rcx + 0 ], 1		#internal_allocate_TMP_1445910543168_0, 1
mov rbx, rcx		#Return_Value93_95, internal_allocate_TMP_1445910543168
jmp Return_Here_132		#Return_Here_132
Return_Here_132:
mov rcx, rbx		#Return_Value93_95_TMP_1445910531520, Return_Value93_95
add qword ptr [rcx + 0 ], 1		#Return_Value93_95_TMP_1445910531520_0, 1
mov rdi, rcx		#this_94_95, Return_Value93_95_TMP_1445910531520
mov rdi, rbx		#this_94_95, Return_Value93_95
mov dword ptr [rdi + 8 ], 1		#this_94_95_8, 1
mov dword ptr [rdi + 12 ], 2		#this_94_95_12, 2
mov rcx, rdi		#this_94_95_TMP_1445910561472, this_94_95
add qword ptr [rcx + 0 ], 1		#this_94_95_TMP_1445910561472_0, 1
mov rsi, rcx		#Return_Value94_95, this_94_95_TMP_1445910561472
...
mov rcx, rcx		#F_95_TMP_1445910563968, F_95_REG1
add qword ptr [rcx + 0 ], 1		#F_95_TMP_1445910563968_0, 1
mov rcx, rcx		#handle_1_95, F_95_TMP_1445910563968
...
call _V17internal_allocatex_rPh
mov rcx, rax		#internal_allocate_TMP_1445910570624, RetREG_0
add qword ptr [rcx + 0 ], 1		#internal_allocate_TMP_1445910570624_0, 1
mov rbx, rcx		#Return_Value93, internal_allocate_TMP_1445910570624
jmp Return_Here_129		#Return_Here_129
Return_Here_129:
mov rcx, rbx		#Return_Value93_TMP_1445910613056, Return_Value93
add qword ptr [rcx + 0 ], 1		#Return_Value93_TMP_1445910613056_0, 1
mov rdi, rcx		#this_94, Return_Value93_TMP_1445910613056
mov rdi, rbx		#this_94, Return_Value93
mov dword ptr [rdi + 8 ], 1		#this_94_8, 1
mov dword ptr [rdi + 12 ], 2		#this_94_12, 2
mov rcx, rdi		#this_94_TMP_1445910584768, this_94
add qword ptr [rcx + 0 ], 1		#this_94_TMP_1445910584768_0, 1
mov rsi, rcx		#Return_Value94, this_94_TMP_1445910584768
...
mov rcx, rcx		#F_TMP_1445910587264, F_REG1
add qword ptr [rcx + 0 ], 1		#F_TMP_1445910587264_0, 1
mov rcx, rcx		#handle_1, F_TMP_1445910587264
...
mov r8, rcx		#this_TMP_1445910594752, this
add qword ptr [r8 + 0 ], 1		#this_TMP_1445910594752_0, 1
mov rbx, r8		#Address_92, this_TMP_1445910594752
