...
add qword ptr [rcx + 0 ], 1		#b_TMP_1710108127792_0, 1
mov rcx, rcx		#this_55, b_TMP_1710108127792
...
mov rcx, rcx		#b_TMP_1710108149296, b_REG1
add qword ptr [rcx + 0 ], 1		#b_TMP_1710108149296_0, 1
mov rcx, rcx		#this_53, b_TMP_1710108149296
...
mov r9, r9		#b_TMP_1710108151984, b_REG3
add qword ptr [r9 + 0 ], 1		#b_TMP_1710108151984_0, 1
mov rdi, r9		#this_54, b_TMP_1710108151984
...
mov r8, rcx		#this_TMP_1710108129584, this
add qword ptr [r8 + 0 ], 1		#this_TMP_1710108129584_0, 1
mov rbx, r8		#Address_52, this_TMP_1710108129584
