...
mov rcx, rcx		#a_TMP_1541935240816, a_REG0
add qword ptr [rcx + 0 ], 1		#a_TMP_1541935240816_0, 1
mov rbx, rcx		#this_61, a_TMP_1541935240816
...
mov r9, rdx		#REG_Size_57_612_REMAINDER9930, REMAINDER_13977
mov eax, 4		#4_QUOTIENT22704, 4
mul r8d		#REG_Size_57_612
mov r8d, eax		#REG_Size_57_612, 4_QUOTIENT22704
mov rdx, r9		#REMAINDER_13977, REG_Size_57_612_REMAINDER9930
mov ecx, ecx		#REG_Size_57_613, Size_57_61
mov r8, rdx		#REG_Size_57_613_REMAINDER31673, REMAINDER_22386
mov eax, 4		#4_QUOTIENT2306, 4
mul ecx		#REG_Size_57_613
mov ecx, eax		#REG_Size_57_613, 4_QUOTIENT2306
mov rdx, r8		#REMAINDER_22386, REG_Size_57_613_REMAINDER31673
...
mov r8, rcx		#this_TMP_1541935249456, this
add qword ptr [r8 + 0 ], 1		#this_TMP_1541935249456_0, 1
mov rbx, r8		#Address_60, this_TMP_1541935249456
mov rbx, rcx		#Address_60, this
mov rcx, rbx		#REG_Address_60_Parameter31115, Address_60
mov edx, 8		#REG_8_Parameter4639, 8
