...
mov rcx, rcx		#a_TMP_1445921857152, a_REG0
add qword ptr [rcx + 0 ], 1		#a_TMP_1445921857152_0, 1
mov rbx, rcx		#this_109, a_TMP_1445921857152
...
mov r8, rcx		#this_TMP_1445921853824, this
add qword ptr [r8 + 0 ], 1		#this_TMP_1445921853824_0, 1
mov rbx, r8		#Address_108, this_TMP_1445921853824
