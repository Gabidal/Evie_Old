...
mov rcx, rcx		#a_TMP_2097106971568, a_REG0
add qword ptr [rcx + 0 ], 1		#a_TMP_2097106971568_0, 1
mov rbx, rcx		#this_61, a_TMP_2097106971568
...
mov rcx, rcx		#a_TMP_2097106984528, a_REG6
add qword ptr [rcx + 0 ], 1		#a_TMP_2097106984528_0, 1
mov rbx, rcx		#this_62, a_TMP_2097106984528
if_23:
...
mov rcx, rcx		#a_TMP_2097106991440, a_REG21
add qword ptr [rcx + 0 ], 1		#a_TMP_2097106991440_0, 1
mov rbx, rcx		#this_63, a_TMP_2097106991440
if_25:
...
mov rcx, rcx		#a_TMP_2097107005264, a_REG36
add qword ptr [rcx + 0 ], 1		#a_TMP_2097107005264_0, 1
mov rcx, rcx		#this_64, a_TMP_2097107005264
sub dword ptr [rcx + 12 ], 1		#this_64_12, 1
Return_Here_90:
mov ecx, 0		#i_65, 0
lea r8, qword ptr [rsp + 0 ]		#a_REG37, .STACK_0
mov r8, r8		#a_TMP_2097108053456, a_REG37
add qword ptr [r8 + 0 ], 1		#a_TMP_2097108053456_0, 1
mov r8, r8		#this_65, a_TMP_2097108053456
if_27:
...
mov r8, rcx		#this_TMP_2097108045680, this
add qword ptr [r8 + 0 ], 1		#this_TMP_2097108045680_0, 1
mov rbx, r8		#Address_60, this_TMP_2097108045680
