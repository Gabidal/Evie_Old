...
.cfi_def_cfa_offset 16		#16
sub rsp, 8		#.STACK, 8
mov dword ptr [rsp + 0 ], ecx		#.STACK_0, x
mov dword ptr [rsp + 4 ], edx		#.STACK_4, y
.loc 1 10 2		#1 10 2
...
.cfi_def_cfa_offset 16		#16
sub rsp, 8		#.STACK, 8
movss dword ptr [rsp + 0 ], xmm0		#.STACK_0, x
movss dword ptr [rsp + 4 ], xmm1		#.STACK_4, y
.loc 1 14 2		#1 14 2
mov eax, 1		#Returning_REG0, 1
add rsp, 8		#.STACK, 8
ret 		#
...
.loc 1 38 15		#1 38 15
mov dword ptr [rsp + 4 ], 1		#.STACK_4, 1
mov dword ptr [rsp + 0 ], 1		#.STACK_0, 1
.loc 1 10 2		#1 10 2
mov ecx, 5		#Return_Value0, 5
jmp Return_Here_0		#Return_Here_0
.loc 1 38 9		#1 38 9
Return_Here_0:
mov eax, ecx		#Returning_REG1, Return_Value0
add rsp, 8		#.STACK, 8
ret 		#
add rsp, 8		#.STACK, 8
ret 		#
...
.byte 4		#4
.byte 7		#7
.quad _Z3fooii_START		#_Z3fooii_START
.long _Z3fooii_END		#_Z3fooii_END
.byte 1		#1
.byte 87		#87
.asciz "foo"		#foo
.byte 1		#1
...
.byte 1		#1
.byte 22		#22
.long _func_START-Debug_Info_Start		#_func_START-Debug_Info_Start
.byte 12		#12
.byte 2		#2
.byte 145		#145
.byte 0		#0
.asciz "i"		#i
.asciz "Return_Value0"		#Return_Value0
.byte 1		#1
.byte 38		#38
.long _int_START-Debug_Info_Start		#_int_START-Debug_Info_Start
.byte 11		#11
